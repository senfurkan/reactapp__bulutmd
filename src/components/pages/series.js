...
import '../../App.css';
import SeriesRecords from './series.json';
    ...
    return (
        ...
        <div className='series'>
            ...
            <div className="search-container">
                <input className='search__bar' type='text' placeholder='Dizilerde Ara...'
                ...
                {SeriesRecords.filter((val) => {
                    ...
                    return (
                        <div className='box' key={key}>
                            ...
                            <p className='box__text'>{val.title}
                            </p>
